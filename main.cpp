...
int main(int argc, char const *argv[])
{
    ...
    auto tiempoSecuencial = duration_cast<microseconds>(finalSecuencial - inicialSecuencial);

    std::cout << "Tiempo secuencial: " << tiempoSecuencial.count() << " μs" << std::endl;
